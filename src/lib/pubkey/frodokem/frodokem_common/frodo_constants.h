...
class BOTAN_TEST_API FrodoKEMConstants final {
   public:
      ...
      size_t len_public_key_bytes() const {
         return (m_len_a + (m_d * m_n * m_n_bar)) / 8;
      }
