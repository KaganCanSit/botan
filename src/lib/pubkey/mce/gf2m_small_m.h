...
class BOTAN_TEST_API GF2m_Field {
   public:
      ...
      gf2m gf_mul(gf2m x, gf2m y) const {
         return ((x != 0) ? gf_mul_fast(x, y) : 0);
      }

      gf2m gf_square(gf2m x) const {
         return ((x != 0) ? gf_exp(_gf_modq_1(gf_log(x) << 1)) : 0);
      }
      ...
      gf2m gf_mul_fast(gf2m x, gf2m y) const {
         return ((y != 0) ? gf_exp(_gf_modq_1(gf_log(x) + gf_log(y))) : 0);
      }
      ...
      */
      ...
      gf2m gf_div_zzr(gf2m x, gf2m b) const {
         return ((x != 0) ? gf_exp(_gf_modq_1(gf_log(x) - b)) : 0);
      }
